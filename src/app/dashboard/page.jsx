  ...
  return (
    <div className=" space-y-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="bg-[#4A7C59] hover:bg-[#3d6649] text-white px-6 py-2.5 rounded-full text-sm font-medium transition-colors shadow-sm flex items-center gap-2">
          Start New Roadmap
          <svg
